function [pE,pC,x] = WholeBrainspm_dcm_fmri_priors(A,B,C,D,options, DTInorm, TractographyPriorValues)
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%Use structural connectivity information for prior

aprior = TractographyPriorValues(1);
bprior = TractographyPriorValues(2);
Soprior = TractographyPriorValues(3);
